...
/**
 * create_buffer -1024 bytes are allocated fo a buffer
 ...
 * Return: 0 on success
 * Description: if the argument count is in incorrect - exit code 97
...
int main(int argc, char *argv[])
{
	...
	if (argc != 3)
	{
		dprintf(STDERR_FILENO, "Usage: cp file_grom file_to\n");
		exit(97);
	}
